...
export async function addOperation(operation: Partial<Operation>) {
  try {
    ...
    const newOperation: Operation = {
      ...
      updatedAt: new Date(),
      scheduled_date: operation.scheduled_date || new Date().toISOString(),
      estimated_duration: operation.estimated_duration || 0,
      ...
      moisture: operation.moisture || 0,
      impurities: operation.impurities ?? 0,
      test_weight: operation.test_weight || 0,
